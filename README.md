...
- **v1**: checkout to the [v1 branch](https://github.com/nhat8002nguyen/audio-stream-be/tree/v1) <br>
...
- **v2**: checkout to the [v2 branch](https://github.com/nhat8002nguyen/audio-stream-be/tree/v2) <br>
...
- **v3**: checkout to the [v3 branch](https://github.com/nhat8002nguyen/audio-stream-be/tree/v3) <br>
  Proposed on 2019, merged to master on 2020. <br>
  Desc: Introducing Domain package, the details can be seen on this PR [#21](https://github.com/nhat8002nguyen/audio-stream-be/pull/21)
...
- **v4**: master branch
  ...
  Details can be seen in this PR [#88](https://github.com/nhat8002nguyen/audio-stream-be/pull/88).<br>
...
![golang clean architecture](https://github.com/nhat8002nguyen/audio-stream-be/raw/master/clean-arch.png)
...
$ git clone https://github.com/nhat8002nguyen/audio-stream-be.git
...
- All libraries listed in [`go.mod`](https://github.com/nhat8002nguyen/audio-stream-be/blob/master/go.mod)
